...
| INV-9 | **Decided value equals executed value.** The gateway accepts only the decision-carried intent and re-verifies its digest immediately before dispatch. | B1 | slice `CORE-S012` |
